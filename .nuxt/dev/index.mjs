globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { promises, mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/h3/dist/index.mjs';
import nodemailer from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/nodemailer/lib/nodemailer.js';
import { createRenderer } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/radix3/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve } from 'file:///Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/node_modules/pathe/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_avxLQv = () => Promise.resolve().then(function () { return sendMail_post$1; });
const _lazy_nk0Dlm = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/api/sendMail', handler: _lazy_avxLQv, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_nk0Dlm, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nk0Dlm, lazy: true, middleware: false, method: undefined }
];
...
const sendMail_post$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
...
const getClientManifest = () => import('/Users/zafarcik.polvongmail.com/Documents/Zafar/Melbournemasterworks/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
